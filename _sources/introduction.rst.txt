...
* `Claude Debussy - Suite Bergamasque (A corpus of annotated scores) <https://github.com/DCMLab/debussy_suite_bergamasque/archive/refs/heads/main.zip>`__
...
-  ``harmonies/l075-01_suite_prelude.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/debussy_suite_bergamasque/issues>`__ and feel free to fork and submit pull requests.
